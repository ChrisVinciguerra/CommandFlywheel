...
public class VelocityDriveCommand extends CommandBase {
    ...
    public void initialize(){
        SmartDashboard.putString("Drive Type", "Velocity");
    }
    ...
    public void execute() {
        ...
        double leftVoltage = DrivetrainConstants.kFeedForward.calculate(wheelSpeeds.leftMetersPerSecond);
        double rightVoltage = DrivetrainConstants.kFeedForward.calculate(wheelSpeeds.rightMetersPerSecond);
